...
const Color _kCustomHighlighterBorder=CupertinoDynamicColor.withBrightness(
  color: Color(0xFF74C5FF),
  darkColor: Color(0xFF74C5FF),
);
...
class CupertinoPicker extends StatefulWidget {
  ...
  CupertinoPicker({
    ...
    bool looping = false,
    this.buildMagnifierScreen=false
  ...
  final bool buildMagnifierScreen;
...
class _CupertinoPickerState extends State<CupertinoPicker> {
  ...
  Widget _buildMagnifierScreen() {
    final Color resolvedBorderColor = CupertinoDynamicColor.resolve(_kCustomHighlighterBorder, context);
    ...
    final Widget result = DefaultTextStyle(
      ...
      child: Stack(
        children: <Widget>[
          ...
          widget.buildMagnifierScreen?_buildMagnifierScreen():Container(),
        ],
      ),
    );
